...
const IPO = () => {
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-white">IPO Center</h1>
      <div className="glass-panel rounded-2xl p-8 flex items-center justify-center min-h-[400px]">
        <div className="text-center space-y-4">
          ...
          <p className="text-neutral-light">The IPO Center functionality is being wired to the backend API.</p>
        </div>
      </div>
    </div>
  );
